...
class _LoginPageState extends State<LoginPage> {
  ...
  void validateAndSubmit() async {
    if (validateAndSave()) {
      ...
      try {
        ...
        String msg;
        _formType== FormType.login ? msg='Login Failed':msg='Registration Failed';
  ...
  List<Widget> usernameAndPassword() {
      ...
      BoxShadow(
       ...
       Padding(
        ...
        decoration:InputDecoration(
              ...
              prefixIcon: Icon(Icons.enhanced_encryption,color: Colors.green[400],),
              hintStyle: TextStyle(color: Colors.grey),
              filled: true,
              fillColor: Colors.white70,
              enabledBorder: OutlineInputBorder(
    ...
    boxShadow: [
      BoxShadow(
        ...
        autocorrect: false,
        validator: (val) => val.isEmpty ? 'Username can\'t be empty.' : val.length<2? 'user name must be at least 2 charecter long':null,
    ...
    switch (_formType) {
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            Image(image: AssetImage("lib/image/google_logo.png"), height: 35.0),
            Padding(
  ...
  Column(
     ...
     children:[ new FlatButton(
        ...
        child:    new Row(
          mainAxisAlignment: MainAxisAlignment.center,
            children:[ new Text("Have an account? ",
            style: TextStyle(
              color: Colors.black54,
            )
            ),
